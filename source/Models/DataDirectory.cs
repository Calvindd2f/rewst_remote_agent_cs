...
namespace Rewst.RemoteAgent.Calvindd2f.Models
{
	public class DataDirectory
	{
		...
		public static  Rewst.RemoteAgent.Calvindd2f.Models.DataDirectory Create(byte[] byteContents, bool isLittleEndian = false)
		{
			...
			return new  Rewst.RemoteAgent.Calvindd2f.Models.DataDirectory
			{
