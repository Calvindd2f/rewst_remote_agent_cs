namespace Rewst.RemoteAgent.Helpers
{
	...
	{
        private readonly bool k__BackingField;

        public byte[] Contents
        {
            [System.Runtime.CompilerServices.CompilerGenerated]
            get => this.< Contents > k__BackingField;
            [System.Runtime.CompilerServices.CompilerGenerated]
            set => this.< Contents > k__BackingField = value;
        }

        public int AttrCertOffset
        {
            [System.Runtime.CompilerServices.CompilerGenerated]
            get => this.< AttrCertOffset > k__BackingField;
            [System.Runtime.CompilerServices.CompilerGenerated]
            set => this.< AttrCertOffset > k__BackingField = value;
        }

        public int CertSizeOffset
        {
            [System.Runtime.CompilerServices.CompilerGenerated]
            get => this.< CertSizeOffset > k__BackingField;
            [System.Runtime.CompilerServices.CompilerGenerated]
            set => this.< CertSizeOffset > k__BackingField = value;
        }

        public byte[] Asn1Bytes
        {
            [System.Runtime.CompilerServices.CompilerGenerated]
            get => this.< Asn1Bytes > k__BackingField;
            [System.Runtime.CompilerServices.CompilerGenerated]
            set => this.< Asn1Bytes > k__BackingField = value;
        }

        public byte[] AppendedTag
        {
            [System.Runtime.CompilerServices.CompilerGenerated]
            get => this.< AppendedTag > k__BackingField;
            [System.Runtime.CompilerServices.CompilerGenerated]
            set => this.< AppendedTag > k__BackingField = value;
        }

        public static  Rewst.RemoteAgent.Helpers.PE32Binary Create(byte[] byteContents)
		{
			 System.Tuple<int, int, int> attributeCertificates =  Rewst.RemoteAgent.Helpers.PE32Binary.GetAttributeCertificates(byteContents);
			int item = attributeCertificates.Item1;
			int item2 = attributeCertificates.Item2;
			int item3 = attributeCertificates.Item3;
			 System.Tuple<byte[], byte[]> tuple =  Rewst.RemoteAgent.Helpers.PE32Binary.ProcessAttributeCertificates( Rewst.RemoteAgent.Helpers.ByteHelper.Slice(byteContents, item, item + item2));
			byte[] item4 = tuple.Item1;
			byte[] item5 = tuple.Item2;
			return new  Rewst.RemoteAgent.Helpers.PE32Binary
			{
		...
		public string GetAppendedTag()
		{
			...
			return  Rewst.RemoteAgent.Helpers.ByteHelper.ConvertByteToString(this.AppendedTag);
		}
		...
		private static  System.Tuple<int, int, int> GetAttributeCertificates(byte[] byteContents)
		{
			...
			uint num =  Rewst.RemoteAgent.Helpers.ByteHelper.CalculateLittleEndianToUInt32( System.Linq.Enumerable.ToArray<byte>( System.Linq.Enumerable.Skip<byte>(byteContents, 0x3C)));
			...
			byte[] array =  Rewst.RemoteAgent.Helpers.ByteHelper.Slice(byteContents, (int)num,  System.Linq.Enumerable.Count<byte>(byteContents));
			byte[] array2 = new byte[4];
			array2[0] =  Rewst.RemoteAgent.Helpers.ByteHelper.ConvertCharToByte('P');
			array2[1] =  Rewst.RemoteAgent.Helpers.ByteHelper.ConvertCharToByte('E');
			byte[] array3 = array2;
			byte[] array4 =  Rewst.RemoteAgent.Helpers.ByteHelper.Slice(array, 0, 4);
			...
			array =  Rewst.RemoteAgent.Helpers.ByteHelper.Slice(array, 4,  System.Linq.Enumerable.Count<byte>(array));
			...
			array =  Rewst.RemoteAgent.Helpers.ByteHelper.Slice(array, 0x14,  System.Linq.Enumerable.Count<byte>(array));
			...
			array =  Rewst.RemoteAgent.Helpers.ByteHelper.Slice(array, 0x18,  System.Linq.Enumerable.Count<byte>(array));
			int num2;
			...
			array =  Rewst.RemoteAgent.Helpers.ByteHelper.Slice(array, num3,  System.Linq.Enumerable.Count<byte>(array));
			uint num4 =  Rewst.RemoteAgent.Helpers.ByteHelper.CalculateLittleEndianToUInt32( System.Linq.Enumerable.ToArray<byte>( System.Linq.Enumerable.Take<byte>(array, 4)));
			array =  Rewst.RemoteAgent.Helpers.ByteHelper.Slice(array, 4,  System.Linq.Enumerable.Count<byte>(array));
			if (num4 > 0x1000U)
			{
			...
			num3 = 0;
			 System.Collections.Generic.List< Rewst.RemoteAgent.Calvindd2f.Models.DataDirectory> list = [];
			int num5 = 0;
			...
			if ( Rewst.RemoteAgent.Helpers.ByteHelper.CalculateLittleEndianToUInt32( Rewst.RemoteAgent.Helpers.ByteHelper.Slice(byteContents, (int)num7,  System.Linq.Enumerable.Count<byte>(byteContents))) != dataDirectory2.Size)
			{
		...
		public static string GetTenantName()
		{
			...
			try
			{
				result =  Rewst.RemoteAgent.Helpers.PE32Binary.Create( System.IO.File.ReadAllBytes( System.Windows.Forms.Application.ExecutablePath)).GetAppendedTag();
			}
		...
		private static  System.Tuple<byte[], byte[]> ProcessAttributeCertificates(byte[] attributeCertificates)
		{
			...
			ulong num = (ulong) Rewst.RemoteAgent.Helpers.ByteHelper.CalculateLittleEndianToUInt32( System.Linq.Enumerable.ToArray<byte>( System.Linq.Enumerable.Take<byte>(attributeCertificates, 4)));
			ushort num2 =  Rewst.RemoteAgent.Helpers.ByteHelper.CalculateLittleEndianToUInt16( Rewst.RemoteAgent.Helpers.ByteHelper.Slice(attributeCertificates, 4, 6));
			ushort num3 =  Rewst.RemoteAgent.Helpers.ByteHelper.CalculateLittleEndianToUInt16( Rewst.RemoteAgent.Helpers.ByteHelper.Slice(attributeCertificates, 6, 8));
			...
			byte[] array =  Rewst.RemoteAgent.Helpers.ByteHelper.Slice(attributeCertificates, 8, attributeCertificates.Length);
			if (array.Length < 2)
			{
				throw new  System.Exception("ProcessAttributeCertificates: ASN.1 structure truncated.");
			}
			int lengthAsn =  Rewst.RemoteAgent.Helpers.PE32Binary.GetLengthAsn1(array);
			return new  System.Tuple<byte[], byte[]>( Rewst.RemoteAgent.Helpers.ByteHelper.Slice(array, 0, lengthAsn),  Rewst.RemoteAgent.Helpers.ByteHelper.Slice(array, lengthAsn, array.Length));
		}
