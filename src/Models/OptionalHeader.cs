namespace Rewst.RemoteAgent.Models
{
    internal class OptionalHeader
	{
		...
		public static  Rewst.RemoteAgent.Models.OptionalHeader Create(byte[] byteContents, bool isLittleEndian = false)
		{
			...
			return new  Rewst.RemoteAgent.Models.OptionalHeader
			{
